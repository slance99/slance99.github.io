...
When designing this visualization, I wanted to select and answer three questions with my plots that would provide a non-scientific audience a better understanding of the Ring of Fire and the mechanics behind its formation. These questions are:
...
Each question inherently links to one another, as composite volcanoes form in subduction zones, which primarily generate Andesite, which are located around the borders of the Pacific Ocean. This creates a strong, intertwined narriative that will communicate the information in a clear and concise way.
...
This figure is meant to answer the second question of the three: **what type of rock are composite volcanoes made of**? The bar chart reveals that the majority of composite volcanoes are Andesites, with Basalts and Trachyandesites also being common.
...
The final figure in the infographic is meant to answer the third question of the three: **what geologic environment do composite volcanoes primarily form in**? The donut chart shows that the majority of composite volcanoes form in subduction zones, with rift zones and hotspots being less common.
